    ...
    return (
        <form onSubmit={handleSubmit} className="form">
            ...
            <div className="divTitle">
                <input type="text" onChange={handleInputChange} name='title' defaultValue={ values.title} placeholder="Title"></input>
            </div>
            <div className="divtext">
                <textarea onChange={handleInputChange} name='description' defaultValue={values.description} placeholder="Your text here..." ></textarea>
            </div>
